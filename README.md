...
- [🏗️ Arquitetura Técnica - FCG Identity Microservice](#️-arquitetura-técnica---fcg-identity-microservice)
  ...
  - [📊 Monitoramento e Observabilidade](#-monitoramento-e-observabilidade)
    - [📈 Observability Stack Completa - Prometheus, Loki, Tempo \& Grafana](#-observability-stack-completa---prometheus-loki-tempo--grafana)
    - [🔍 Telemetry Flow \& Correlation com OpenTelemetry](#-telemetry-flow--correlation-com-opentelemetry)
